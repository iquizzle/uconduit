...
translate([0,0,12/2]) bearingPlate();
translate([0,bearingH+4+35/2+drop+5,2]) rotate([0,0,0]) bottom_clip();
...
difference(){
translate([-35/2+12/2,35/2+12/2,0]) cube([12.01,12.01,12.01],center=true);
...
difference(){
union(){
cylinder(r=bearingID/2+2,h=drop-3,center=true);
translate([0,0,1.5]) cube([12.01,12.01,12.01],center=true);}
