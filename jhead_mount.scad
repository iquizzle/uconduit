...
translate([-bushingL/2+3.5,8-screw_sep,14]) rotate([0,0,0]) cylinder(r=3.5/2+0.05,h=30,center=true);
for ( pp = [0 : 0.25 : 8] ){
translate([-bushingL/2+3.5-pp,8-screw_sep,4]) rotate([0,180,0]) boltHole(4,length=10);
translate([-bushingL/2+3.5-pp,8-screw_sep,3]) rotate([0,180,0]) boltHole(4,length=10);}
...
union(){
translate([0,0,4.5-0.01]) cylinder(r=5/16*25.4,h=5.5);
translate([0,0,0]) cylinder(r=12/2,h=4.64);
translate([0,0,-10+0.01]) cylinder(r=5/16*25.4,h=10);
if (fil == 1){
