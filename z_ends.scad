...
//Bearing Hole
translate([-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),ACMENutH/2-0.1]) cylinder(r=15/2,h=ACMENutH+1,center=true);
}
else if(type==2){
...
module z_hexclamp(){
height = 15.3-ACMENutH;
difference(){
union(){
translate([28,28,2]) rotate([0,0,180]) fillet(16,4);
translate([0,0,-height+4]) cross_section(15.3-ACMENutH,type=1);
}
...
translate([-6+9,-6-9,-0.1-height+4]) cylinder(r=2+0.05,h=height+2);
//translate([-15,-15,-0.1-height+4]) cylinder(r=2+0.05,h=height+2);
...
rotate([0,0,-15]) translate([31,31,-0.1]) rotate([0,0,45]) cube([80,80,15],center=true);
translate([-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),-0.1-height+4]) cylinder(r=15/2,h=height+2);
}}
...
translate([-6+8,-6-8,0]) circle(r=3);
translate([-28/2,-28/2,0]) rotate([0,0,45]) square([28,15],center=true);
translate([-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),-6-(((35/sqrt(2)+42.3/sqrt(2))-(35/sqrt(2)+6.5))/sqrt(2)),0]) circle(r=15/2);
}
}
circle(r=4);}}
else{
